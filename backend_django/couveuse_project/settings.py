"""
Django settings for couveuse_project project.
...
SECRET_KEY = 'django-insecure-4-ge0hrtbc=s0o*wv3gi%m#g7vyulmx2_#p1ur5zu74+%b4(1z'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'couveuse_app' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
